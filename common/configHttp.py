...
if __name__ == '__main__':  # 通过写死参数，来验证我们写的请求是否正确
    result1 = RunMain().run_main('post', 'http://127.0.0.1:5000/login', {'name': 'xiaoming', 'pwd': '111222'})
    result2 = RunMain().run_main('get', 'http://127.0.0.1:5000/login', 'name=xiaoming&pwd=111')
    print(result1)
    print(result2)
